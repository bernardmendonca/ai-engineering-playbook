...
For detailed data classification frameworks (Public/Internal/Restricted tiers, repo-level classification, enforcement mechanisms, and file exclusion patterns), see [05 — Data Classification](../05-security/data-classification.md).
...
- Security controls → [05 — Security](../05-security/)
