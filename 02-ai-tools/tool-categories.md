...
> **Note:** These same tools also offer agent/chat capabilities at their paid tiers. For a detailed comparison of agent-mode features, enterprise readiness, and cost-at-scale projections, see [03 — Agent Landscape](../03-ai-coding-agents/agent-landscape.md).
...
**What it does:** Autonomous multi-step task execution. See [03 — AI Coding Agents](../03-ai-coding-agents/) for comprehensive coverage.
...
- Deep dive on coding agents specifically? → [03 — AI Coding Agents](../03-ai-coding-agents/)
