...
1. Start with free tiers — genuinely generous options exist (see [Getting Started Free](../ai-coding-agents/getting-started-free.md))
...
- Ready to choose tools? → [AI Tools](../ai-tools/)
