...
```mermaid
flowchart LR
    A[Innovators<br/>5%] --> B[Early Adopters<br/>15%]
    B --> C[Early Majority<br/>35%]
    C --> D[Late Majority<br/>35%]
    D --> E[Laggards<br/>10%]

    A -.- A1[Already using on their own<br/>Need: approval and guardrails]
    B -.- B1[Excited to try<br/>Need: access and light guidance]
    C -.- C1[Will use if easy and proven<br/>Need: evidence, training, support]
    D -.- D1[Skeptical but open<br/>Need: peer proof, mandate-free option]
    E -.- E1[Will resist<br/>Need: respect, time, optionality]
```
...
|:-----:|-------------------|-----------|
| **0** | No AI tools, no awareness | Start at [Foundations](../foundations/) |
