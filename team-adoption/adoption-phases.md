...
For detailed pilot execution guidance (team selection criteria, pilot structure week-by-week, metrics to track, anti-patterns): see [Production Rollout: Stage 1](../ai-coding-agents/production-rollout.md).
...
For detailed expansion strategy (wave-based vs. opt-in, community building, standardization decisions, cost projections, enterprise procurement checklist): see [Production Rollout: Stage 2–3](../ai-coding-agents/production-rollout.md).
