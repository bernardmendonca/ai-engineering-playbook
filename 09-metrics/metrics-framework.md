...
For detailed guidance on measurement *methods* (before/after studies, cohort comparison, task timing, surveys, DORA) and how to present results to different audiences, see [06 — Measurement Approaches](../07-productivity/measurement-approaches.md).
...
- Measurement methods in depth → [06 — Measurement Approaches](../07-productivity/measurement-approaches.md)
